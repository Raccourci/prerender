...
var phantom = require('phantom')
  ...
  , logAccess = bunyan.createLogger({
    ...
    streams:[
      {
        level: 'log',
        path:  '/home/admin/logs/server_info.log'
      },
      {
        level: 'info',
        path:  '/home/admin/logs/server_info.log'
      ...
      {
        level: 'warn',
        path:  '/home/admin/logs/server_warn.log'
      },
      {
        level: 'error',
        path:  '/home/admin/logs/server_error.log'
      }
    ]
  ...
  , logTechnical = bunyan.createLogger({
    ...
    streams:[
      {
        level: 'log',
        path:  '/home/admin/logs//technical_info.log'
      },
      {
        level: 'info',
        path:  '/home/admin/logs/technical_info.log'
      ...
      {
        level: 'warn',
        path:  '/home/admin/logs/technical_warn.log'
      },
      {
        level: 'error',
        path:  '/home/admin/logs/technical_error.log'
      }
    ]
  });
