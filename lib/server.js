...
var phantom = require('phantom')
  ...
  , logAccess = bunyan.createLogger({
    ...
    streams:[
      {
        level: 'log',
        path: basePath + '/logs/server_info.log'
      },
      {
        level: 'info',
        path: basePath + '/logs/server_info.log'
      ...
      {
        level: 'warn',
        path: basePath + '/logs/server_warn.log'
      },
      {
        level: 'error',
        path: basePath + '/logs/server_error.log'
      }
    ]
  ...
  , logTechnical = bunyan.createLogger({
    ...
    streams:[
      {
        level: 'log',
        path: basePath + '/logs/technical_info.log'
      },
      {
        level: 'info',
        path: basePath + '/logs/technical_info.log'
      ...
      {
        level: 'warn',
        path: basePath + '/logs/technical_warn.log'
      },
      {
        level: 'error',
        path: basePath + '/logs/technical_error.log'
      }
    ]
  });
...
server.onRequest = function (req, res) {
  ...
  req.log.info('getting', req.prerender.url);
...
server._sendResponse = function (req, res, options) {
  ...
  req.log.info({status:req.prerender.statusCode, duration: ms, url:req.prerender.url});
